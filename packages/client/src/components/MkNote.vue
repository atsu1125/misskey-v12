...
const currentAntennaPage = inject<Ref<misskey.entities.Antenna> | null>('currentAntennaPage', null);
...
function onContextmenu(ev: MouseEvent): void {
	...
	if (defaultStore.state.useReactionPickerForContextMenu) {
		...
		os.contextMenu(getNoteMenu({ note: note, translating, translation, menuButton, isDeleted, currentClipPage, currentAntennaPage }), ev).then(focus);
	}
}

function menu(viaKeyboard = false): void {
	os.popupMenu(getNoteMenu({ note: note, translating, translation, menuButton, isDeleted, currentClipPage, currentAntennaPage }), menuButton.value, {
		viaKeyboard,
	}).then(focus);
}
